...
//go:generate go run ../../cmd/genestype/gen.go -c ./testdata/additional_prop_escape_opt.json -m ./testdata/additional_prop_escape.json -o ./additional_prop_escape.go -p github.com/ngicks/estype/generator/test
